...
ACLOCAL = ${SHELL} /z/UMC/src/build-aux/missing --run aclocal-1.11
AMTAR = ${SHELL} /z/UMC/src/build-aux/missing --run tar
AM_DEFAULT_VERBOSITY = 0
AR = /c/mingw32/bin/ar
AUTOCONF = ${SHELL} /z/UMC/src/build-aux/missing --run autoconf
AUTOHEADER = ${SHELL} /z/UMC/src/build-aux/missing --run autoheader
AUTOMAKE = ${SHELL} /z/UMC/src/build-aux/missing --run automake-1.11
AWK = gawk
BDB_CPPFLAGS = 
...
COPYRIGHT_YEAR = 2015
CPP = gcc -E
CPPFLAGS = -I/c/deps/db-4.8.30.NC/build_unix -I/c/deps/openssl-1.0.1s/include -I/c/deps/libevent-2.0.22/include -I/c/deps -I/c/deps/libevent-2.0.22 -I/c/deps/protobuf-2.6.1/src -I/c/deps/libpng-1.6.16 -I/c/deps/gmp-6.0.0 -I/c/deps/qrencode-3.4.4 -DBOOST_SPIRIT_THREADSAFE -DHAVE_BUILD_INFO -D__STDC_FORMAT_MACROS -D_MT -DWIN32 -D_WINDOWS -DBOOST_THREAD_USE_LIB -D_FILE_OFFSET_BITS=64  -U_FORTIFY_SOURCE -D_FORTIFY_SOURCE=2 -DMINIUPNP_STATICLIB
CRYPTO_CFLAGS = 
CRYPTO_LIBS = 
CXX = g++
CXXCPP = g++ -E
...
LCOV = 
LDFLAGS = -L/c/deps/db-4.8.30.NC/build_unix -L/c/deps/openssl-1.0.1s -L/c/deps/miniupnpc -L/c/deps/protobuf-2.6.1/src/.libs -L/c/deps/libpng-1.6.16/.libs -L/c/deps/gmp-6.0.0/.libs -I/c/deps/libevent-2.0.22/.libs -L/c/deps/qrencode-3.4.4/.libs -static -static-libgcc -static-libstdc++ -Wl,--large-address-aware  -Wl,--dynamicbase -Wl,--nxcompat
LEVELDB_CPPFLAGS = 
...
MAINT = 
MAKEINFO = ${SHELL} /z/UMC/src/build-aux/missing --run makeinfo
MAKENSIS = none
MKDIR_P = /bin/mkdir -p
...
PACKAGE_STRING = Bitcoin Core 0.9.5
...
abs_builddir = /z/UMC
abs_srcdir = /z/UMC
abs_top_builddir = /z/UMC
abs_top_srcdir = /z/UMC
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_OBJC = gcc
ac_ct_OBJCXX = g++
...
install_sh = ${SHELL} /z/UMC/src/build-aux/install-sh
